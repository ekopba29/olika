    ...
    <script>
        $(function() {
            ...
            function build_city() {
                ...
                const idCurrentCity = @php echo $user->city_id ?? 9191919191; @endphp;
            ...
            function build_kecamatan() {
                $("#cities").change(function(e) {
                    if ($("#cities").val() != "") {
                        ...
                        const idCurrentKecamatan = @php echo $user->dis_id ?? 9191919191; @endphp;
            ...
            function build_kelurahan() {
                $("#districts,#cities").change(function(e) {
                    if ($("#districts").val() != "") {
                        ...
                        const idCurrentKelurahan = @php echo $user->subdis_id ?? 9191919191; @endphp;
